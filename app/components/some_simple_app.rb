class SomeSimpleApp < Netzke::Basepack::SimpleApp
  ...
  component :colleges, :class_name => "Basepack::GridPanel", :model => "College", :lazy_loading => true, :title => "List of Colleges"
  component :clerk_grid, :class_name => "ClerkGrid", :lazy_loading => true, :title => "Applicant Grid"
  component :custom_action_grid, :model => "College", :lazy_loading => true, :title => "Custom Action Grid "
#  component :applicant_grid, :lazy_loading => true, :title => "List of Applicants"
