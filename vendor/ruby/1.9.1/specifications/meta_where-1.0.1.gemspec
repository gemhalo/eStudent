...
"open source" stuff to my lovely wife. :)
  ...
  s.test_files = ["test/fixtures/company.rb", "test/fixtures/data_type.rb", "test/fixtures/developer.rb", "test/fixtures/fixed_bid_project.rb", "test/fixtures/invalid_company.rb", "test/fixtures/invalid_developer.rb", "test/fixtures/note.rb", "test/fixtures/person.rb", "test/fixtures/project.rb", "test/fixtures/schema.rb", "test/fixtures/time_and_materials_project.rb", "test/helper.rb", "test/test_base.rb", "test/test_relations.rb"]
