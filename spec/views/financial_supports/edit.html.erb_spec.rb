...
describe "financial_supports/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit financial_support form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => financial_supports_path(@financial_support), :method => "post" do
