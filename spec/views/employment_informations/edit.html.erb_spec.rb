...
describe "employment_informations/edit.html.erb" do
  before(:each) do
  ...
  it "renders the edit employment_information form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => employment_informations_path(@employment_information), :method => "post" do
